...
class HelperService implements HelperContract
{
     ...
     * @return int|string
     */
    public function parseSc2Num(string $scNumber, int $double = 0)
    {
        if(false !== stripos($scNumber, "e"))
        {
            $arr = explode("e",strtolower($scNumber));
            return bcmul($arr[0], bcpow(10, $arr[1], $double), $double);
        }
        return $scNumber;
    }

...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->tinyInteger('vip')->unsigned()->default(0)->comment('VIP');
            $table->integer('level')->unsigned()->default(1)->comment('关卡');
            $table->tinyInteger('levelPoint')->unsigned()->default(0)->comment('关卡进度');
